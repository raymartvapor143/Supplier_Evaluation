...
<body class="bg-gradient-to-br from-orange-400 via-orange-300 to-sky-300 min-h-screen">
    ...
    <div class="flex flex-col lg:flex-row">
      ...
      <main id="mainContent"
      class="flex-1 w-full min-w-0 perspective-1000 p-3 sm:p-4 md:p-6 lg:p-8">
        <div id="flipInner" class="relative bg-white rounded-xl shadow-lg p-6 w-full h-full transition-transform duration-700 ease-in-out transform-style-preserve-3d">
          ...
          <div class="front">
            <div class="mb-6">
              ...
              {{-- <div class="hidden flex flex-wrap justify-start sm:justify-end gap-2" style="margin-top: -60px;"> <!-- Add Evaluation Button --> <button id="openNewEvaluationModalBtn" class="bg-secondary text-white px-4 py-2 rounded-md hover:bg-orange-600 transition-colors text-sm font-medium whitespace-nowrap flex items-center space-x-2">
            ...
            <div class="sticky top-0 z-10 bg-white border-b border-gray-200 mb-6">
              <nav class="flex space-x-4 sm:space-x-6 lg:space-x-8 overflow-x-auto scrollbar-hide whitespace-nowrap">
            ...
            <div class="w-full overflow-x-auto bg-orange-200/60 rounded-lg p-2 sm:p-3 md:p-4 lg:p-6">
