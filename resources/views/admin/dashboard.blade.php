        ...
        <div id="flipInner" class="relative bg-white rounded-xl shadow-lg p-6 w-full h-full transition-transform duration-700 ease-in-out transform-style-preserve-3d">
          ...
          <div class="front">
            <div class="mb-6">
              ...
              <div class="flex flex-wrap justify-start sm:justify-end gap-2 hidden" style="margin-top: -60px;"> <!-- Add Evaluation Button --> <button id="openNewEvaluationModalBtn" class="bg-secondary text-white px-4 py-2 rounded-md hover:bg-orange-600 transition-colors text-sm font-medium whitespace-nowrap flex items-center space-x-2">
...
<div id="calculateModal" class="hidden fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50 transition-opacity duration-300">
    <div class="bg-white rounded-3xl shadow-2xl w-11/12 md:w-4/5 lg:w-3/4 xl:w-2/3 transform scale-95 opacity-0 transition-all duration-500" id="modalBox">
        <div class="p-8">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-3xl font-bold text-gray-800">Evaluation Summary</h2>
                <button class="close-calculate-modal text-gray-500 hover:text-gray-800 transition-colors duration-200">
                    ✕
                </button>
            </div>
            ...
            <div class="mt-6 flex justify-end">
                <button class="close-calculate-modal px-6 py-3 bg-red-600 hover:bg-red-700 text-white rounded-xl transition-all duration-200 shadow-lg">
                    Close
                </button>
            </div>
        </div>
